...
var formatting_native_1 = __webpack_require__(163);
var formatting_cmd_1 = __webpack_require__(51);
var formatting_func_1 = __webpack_require__(164);
...
var scrollbars_1 = __webpack_require__(162);
...
var recurring_event_1 = __webpack_require__(39);
var object_1 = __webpack_require__(4);
function parseEvents(rawEvents, sourceId, calendar) {
    var eventStore = createEmptyEventStore();
    var transform = calendar.opt('eventDataTransform');
    if (transform) {
...
function transformRawEvents(rawEvents, func) {
    var refinedEvents;
    if (!func) {
...
var EventSourceApi_1 = __webpack_require__(139);
var EventApi = /** @class */ (function () {
    ...
    EventApi.prototype.getSource = function () {
    ...
    EventApi.prototype.setDates = function (startInput, endInput, options) {
        if (options === void 0) { options = {}; }
        var dateEnv = this.calendar.dateEnv;
        var standardProps = { isAllDay: options.isAllDay };
        var start = dateEnv.createMarker(startInput);
        var end;
        if (!start) {
            return; // TODO: warning if parsed bad
    ...
    EventApi.prototype.setIsAllDay = function (isAllDay, options) {
        if (options === void 0) { options = {}; }
        var standardProps = { isAllDay: isAllDay };
    ...
    Object.defineProperty(EventApi.prototype, "isAllDay", {
        get: function () { return this.def.isAllDay; },
        enumerable: true,
        configurable: true
    });
...
var dom_manip_1 = __webpack_require__(3);
var misc_1 = __webpack_require__(2);
var event_rendering_1 = __webpack_require__(27);
...
var EventRenderer = /** @class */ (function () {
    ...
    EventRenderer.prototype.rangeUpdated = function () {
        ...
        var displayEventEnd;
        this.eventTimeFormat = formatting_1.createFormatter(this.opt('eventTimeFormat') ||
            this.computeEventTimeFormat(), this.opt('defaultRangeSeparator'));
    ...
    EventRenderer.prototype.getTimeText = function (eventRange, formatter, displayEnd) {
        ...
        return this._getTimeText(instance.range.start, def.hasEnd ? instance.range.end : null, def.isAllDay, formatter, displayEnd, instance.forcedStartTzo, instance.forcedEndTzo);
    };
    EventRenderer.prototype._getTimeText = function (start, end, isAllDay, formatter, displayEnd, forcedStartTzo, forcedEndTzo) {
    ...
    EventRenderer.prototype.sortEventSegs = function (segs, specs) {
        if (specs === void 0) { specs = this.view.eventOrderSpecs; }
...
var dom_manip_1 = __webpack_require__(3);
var Component_1 = __webpack_require__(138);
var marker_1 = __webpack_require__(6);
var duration_1 = __webpack_require__(10);
var event_rendering_1 = __webpack_require__(27);
var event_store_1 = __webpack_require__(14);
var object_1 = __webpack_require__(4);
var browser_context_1 = __webpack_require__(52);
var date_range_1 = __webpack_require__(11);
var EventApi_1 = __webpack_require__(15);
var event_1 = __webpack_require__(28);
var EmitterMixin_1 = __webpack_require__(20);
var validation_1 = __webpack_require__(40);
var uid = 0;
var DateComponent = /** @class */ (function (_super) {
    ...
    DateComponent.prototype.eventRangesToSegs = function (eventRenderRanges) {
        ...
        for (var _i = 0, eventRenderRanges_1 = eventRenderRanges; _i < eventRenderRanges_1.length; _i++) {
            ...
            var segs = this.rangeToSegs(eventRenderRange.range, eventRenderRange.def.isAllDay);
    ...
    DateComponent.prototype.selectionToSegs = function (selection, fabricateEvents) {
        var segs = this.rangeToSegs(selection.range, selection.isAllDay);
        if (fabricateEvents) {
            ...
            selection.isAllDay, true, // hasEnd
            this.getCalendar());
            var eventRange = {
                def: def,
    ...
    DateComponent.prototype.rangeToSegs = function (range, isAllDay) {
        return [];
    };
    // Utils
    // ---------------------------------------------------------------------------------------------------------------
...
function parseEvent(raw, sourceId, calendar) {
    var leftovers0 = {};
    var isAllDayDefault = computeIsAllDayDefault(sourceId, calendar);
    var singleRes = parseSingle(raw, isAllDayDefault, calendar, leftovers0);
    if (singleRes) {
        var def = parseEventDef(leftovers0, sourceId, singleRes.isAllDay, singleRes.hasEnd, calendar);
        ...
        if (recurringRes) {
            var isAllDay = (raw.isAllDay != null) ? Boolean(raw.isAllDay) : // need to get this from `raw` because already stripped out of `leftovers0`
                (isAllDayDefault != null ? isAllDayDefault :
                    recurringRes.isAllDay); // fall back to the recurring date props LAST
            var def = parseEventDef(leftovers1, sourceId, isAllDay, Boolean(recurringRes.duration), calendar);
            def.recurringDef = {
...
*/
function parseEventDef(raw, sourceId, isAllDay, hasEnd, calendar) {
    var leftovers = {};
...
function parseSingle(raw, isAllDayDefault, calendar, leftovers) {
    ...
    if (endMarker) {
        ...
        endMarker = calendar.dateEnv.add(startMarker, isAllDay ?
            calendar.defaultAllDayEventDuration :
            calendar.defaultTimedEventDuration);
    }
    return {
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(1);
var PointerDragging_1 = __webpack_require__(41);
var misc_1 = __webpack_require__(2);
var ElementMirror_1 = __webpack_require__(166);
var ElementDragging_1 = __webpack_require__(53);
var AutoScroller_1 = __webpack_require__(167);
/*
...
Object.defineProperty(exports, "__esModule", { value: true });
var exportHooks = __webpack_require__(37);
exports.viewHash = {};
...
var array_1 = __webpack_require__(134);
...
var ScrollComponent_1 = __webpack_require__(38);
exports.ScrollComponent = ScrollComponent_1.default;
var Theme_1 = __webpack_require__(26);
exports.Theme = Theme_1.default;
var DateComponent_1 = __webpack_require__(21);
exports.DateComponent = DateComponent_1.default;
var Calendar_1 = __webpack_require__(172);
exports.Calendar = Calendar_1.default;
var View_1 = __webpack_require__(43);
exports.View = View_1.default;
var ViewRegistry_1 = __webpack_require__(32);
exports.defineView = ViewRegistry_1.defineView;
exports.getViewConfig = ViewRegistry_1.getViewConfig;
var DayTableMixin_1 = __webpack_require__(57);
exports.DayTableMixin = DayTableMixin_1.default;
var EventRenderer_1 = __webpack_require__(18);
exports.EventRenderer = EventRenderer_1.default;
var FillRenderer_1 = __webpack_require__(58);
exports.FillRenderer = FillRenderer_1.default;
var MirrorRenderer_1 = __webpack_require__(59);
exports.MirrorRenderer = MirrorRenderer_1.default;
var AgendaView_1 = __webpack_require__(145);
exports.AgendaView = AgendaView_1.default;
var TimeGrid_1 = __webpack_require__(146);
exports.TimeGrid = TimeGrid_1.default;
var DayGrid_1 = __webpack_require__(61);
exports.DayGrid = DayGrid_1.default;
var BasicView_1 = __webpack_require__(62);
exports.BasicView = BasicView_1.default;
var MonthView_1 = __webpack_require__(149);
exports.MonthView = MonthView_1.default;
var ListView_1 = __webpack_require__(150);
...
var env_1 = __webpack_require__(55);
exports.DateEnv = env_1.DateEnv;
var locale_1 = __webpack_require__(42);
...
var timezone_1 = __webpack_require__(142);
...
var parsing_1 = __webpack_require__(143);
...
var ExternalDraggable_1 = __webpack_require__(190);
exports.Draggable = ExternalDraggable_1.default;
var ThirdPartyDraggable_1 = __webpack_require__(192);
exports.ThirdPartyDraggable = ThirdPartyDraggable_1.default;
var formatting_api_1 = __webpack_require__(194);
...
var dom_geom_1 = __webpack_require__(13);
var dom_manip_1 = __webpack_require__(3);
var scroll_controller_1 = __webpack_require__(137);
/*
        ...
        this.handleScroll = function (ev) {
            if (!_this.shouldIgnoreMove) {
                _this.emitter.trigger('pointermove', {
                    ...
                    pageX: (window.scrollX - _this.prevScrollX) + _this.prevPageX,
                    pageY: (window.scrollY - _this.prevScrollY) + _this.prevPageY
                });
            }
        };
...
Object.defineProperty(exports, "__esModule", { value: true });
var StandardTheme_1 = __webpack_require__(135);
var JqueryUiTheme_1 = __webpack_require__(136);
var themeClassHash = {};
...
function parseOpenDateSpan(raw, dateEnv) {
    ...
    var isAllDay = standardProps.isAllDay;
    if (isAllDay == null) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var DateClicking_1 = __webpack_require__(165);
var DateSelecting_1 = __webpack_require__(168);
var EventClicking_1 = __webpack_require__(169);
var EventHovering_1 = __webpack_require__(170);
var EventDragging_1 = __webpack_require__(141);
var EventResizing_1 = __webpack_require__(171);
...
mutation, calendar) {
    var dateEnv = calendar.dateEnv;
    var forceAllDay = mutation.standardProps && mutation.standardProps.isAllDay === true;
...
Object.defineProperty(exports, "__esModule", { value: true });
var marker_1 = __webpack_require__(6);
var calendar_system_1 = __webpack_require__(176);
var timezone_1 = __webpack_require__(142);
var duration_1 = __webpack_require__(10);
var formatting_1 = __webpack_require__(8);
var parsing_1 = __webpack_require__(143);
...
var dom_geom_1 = __webpack_require__(13);
var geom_1 = __webpack_require__(25);
var scroll_geom_cache_1 = __webpack_require__(140);
/*
...
var DayTableMixin_1 = __webpack_require__(57);
var DayGridEventRenderer_1 = __webpack_require__(147);
var DayGridMirrorRenderer_1 = __webpack_require__(185);
var DayGridFillRenderer_1 = __webpack_require__(186);
var marker_1 = __webpack_require__(6);
var formatting_1 = __webpack_require__(8);
var DateComponent_1 = __webpack_require__(21);
var DayTile_1 = __webpack_require__(187);
var date_range_1 = __webpack_require__(11);
var OffsetTracker_1 = __webpack_require__(60);
...
var ScrollComponent_1 = __webpack_require__(38);
var View_1 = __webpack_require__(43);
var BasicViewDateProfileGenerator_1 = __webpack_require__(148);
var DayGrid_1 = __webpack_require__(61);
var WEEK_NUM_FORMAT = formatting_1.createFormatter({ week: 'numeric' });
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventRenderer_1 = __webpack_require__(18);
var HitDragging_1 = __webpack_require__(30);
var event_mutation_1 = __webpack_require__(54);
var browser_context_1 = __webpack_require__(52);
var marker_1 = __webpack_require__(6);
var dom_manip_1 = __webpack_require__(3);
var FeaturefulElementDragging_1 = __webpack_require__(29);
var event_store_1 = __webpack_require__(14);
var misc_1 = __webpack_require__(2);
var EventApi_1 = __webpack_require__(15);
...
var formatting_1 = __webpack_require__(8);
var event_store_1 = __webpack_require__(14);
var reselector_1 = __webpack_require__(144);
var event_rendering_1 = __webpack_require__(27);
...
function filterEventsForTimeGrid(eventStore, eventUis) {
    return event_store_1.filterEventStoreDefs(eventStore, function (eventDef) {
        return !eventDef.isAllDay || event_rendering_1.hasBgRendering(eventUis[eventDef.defId]);
    });
}
...
var PositionCache_1 = __webpack_require__(49);
var date_range_1 = __webpack_require__(11);
var TimeGridEventRenderer_1 = __webpack_require__(181);
var TimeGridMirrorRenderer_1 = __webpack_require__(182);
var TimeGridFillRenderer_1 = __webpack_require__(183);
var duration_1 = __webpack_require__(10);
var marker_1 = __webpack_require__(6);
var formatting_1 = __webpack_require__(8);
var DateComponent_1 = __webpack_require__(21);
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg) {
        ...
        var isAllDay = eventDef.isAllDay;
        var isDraggable = eventUi.startEditable;
        var isResizableFromStart = isAllDay && seg.isStart && eventUi.durationEditable && this.opt('eventResizableFromStart');
        var isResizableFromEnd = isAllDay && seg.isEnd && eventUi.durationEditable;
...
var misc_1 = __webpack_require__(2);
var BasicView_1 = __webpack_require__(62);
var MonthViewDateProfileGenerator_1 = __webpack_require__(188);
...
var View_1 = __webpack_require__(43);
var ScrollComponent_1 = __webpack_require__(38);
var ListEventRenderer_1 = __webpack_require__(189);
var marker_1 = __webpack_require__(6);
var formatting_1 = __webpack_require__(8);
var date_range_1 = __webpack_require__(11);
/*
...
var ListView = /** @class */ (function (_super) {
    ...
    // slices by day
    ListView.prototype.rangeToSegs = function (range, isAllDay) {
        var dateEnv = this.getDateEnv();
...
var event_1 = __webpack_require__(28);
var event_store_1 = __webpack_require__(14);
var externalHooks = __webpack_require__(37);
var drag_meta_1 = __webpack_require__(191);
var EventApi_1 = __webpack_require__(15);
var dom_manip_1 = __webpack_require__(3);
var misc_1 = __webpack_require__(2);
var validation_1 = __webpack_require__(40);
...
function computeEventForDateSpan(dateSpan, dragMeta, calendar) {
    var def = event_1.parseEventDef(dragMeta.leftoverProps, dragMeta.sourceId, dateSpan.isAllDay, Boolean(dragMeta.duration), // hasEnd
    calendar);
...
var NativeFormatter = /** @class */ (function () {
    function NativeFormatter(formatSettings) {
        ...
        for (var name_1 in formatSettings) {
            if (name_1 in EXTENDED_SETTINGS_AND_SEVERITIES) {
                ...
                standardSettings[name_1] = formatSettings[name_1];
    ...
    NativeFormatter.prototype.format = function (date, context, standardOverrides) {
        var standardSettings = object_1.assignTo({}, standardOverrides || this.standardSettings); // always copy (efficient?)
        var extendedSettings = this.extendedSettings;
        ...
        if (context.timeZone !== 'UTC' && (standardSettings.timeZoneName === 'long' ||
        ...
        var s = date.marker.toLocaleString(context.locale.codeArg, standardSettings);
        if (context.timeZone !== 'UTC' && // the current timezone is something other than UTC
            ...
            s = s.replace(/UTC|GMT/, formatting_1.formatTimeZoneOffset(date.timeZoneOffset));
        }
    ...
    NativeFormatter.prototype.formatRange = function (start, end, context) {
        var standardSettings = this.standardSettings;
        ...
        var partialFormatSettings = computePartialFormattingOptions(standardSettings, biggestUnitForPartial);
        var partial0 = this.format(start, context, partialFormatSettings);
        var partial1 = this.format(end, context, partialFormatSettings);
        var insertion = findCommonInsertion(full0, partial0, full1, partial1);
        var separator = this.extendedSettings.separator || '';
        if (insertion) {
    ...
    function AutoScroller() {
        ...
        this.animate = function () {
            if (_this.isAnimating) { // wasn't cancelled between animation calls
                var edge = _this.computeBestEdge(_this.pointerScreenX + window.scrollX, _this.pointerScreenY + window.scrollY);
                if (edge) {
                    var now = getTime();
...
var OptionsManager_1 = __webpack_require__(174);
var ViewSpecManager_1 = __webpack_require__(175);
var ThemeRegistry_1 = __webpack_require__(48);
var locale_1 = __webpack_require__(42);
var env_1 = __webpack_require__(55);
var marker_1 = __webpack_require__(6);
var formatting_1 = __webpack_require__(8);
var duration_1 = __webpack_require__(10);
var main_1 = __webpack_require__(177);
var date_span_1 = __webpack_require__(50);
var reselector_1 = __webpack_require__(144);
var object_1 = __webpack_require__(4);
var date_range_1 = __webpack_require__(11);
...
var event_store_1 = __webpack_require__(14);
var event_rendering_1 = __webpack_require__(27);
var business_hours_1 = __webpack_require__(180);
var PointerDragging_1 = __webpack_require__(41);
var EventDragging_1 = __webpack_require__(141);
var Calendar = /** @class */ (function () {
    function Calendar(el, overrides) {
        ...
        this.viewSpecManager = new ViewSpecManager_1.default(this.optionsManager);
    ...
    Calendar.prototype.applyElClassNames = function () {
        ...
        var elDirClassName = this.opt('isRtl') ? 'fc-rtl' : 'fc-ltr';
    ...
    */
    ...
    Calendar.prototype.formatRange = function (d0, d1, formatter, isEndExclusive) {
        var dateEnv = this.dateEnv;
        return dateEnv.formatRange(dateEnv.createMarker(d0), dateEnv.createMarker(d1), formatting_1.createFormatter(formatter, this.opt('defaultRangeSeparator')), { isEndExclusive: isEndExclusive });
    };
    ...
    Calendar.prototype.renderToolbars = function (forceFlags) {
        ...
        if (footerLayout) {
            if (!this.footer) {
                ...
                dom_manip_1.prependToElement(this.el, this.footer.el);
            }
...
var ViewSpecManager = /** @class */ (function () {
    function ViewSpecManager(optionsManager) {
    ...
    ViewSpecManager.prototype.getUnitViewSpec = function (unit, calendar) {
        var viewTypes;
        var i;
        var spec;
...
Object.defineProperty(exports, "__esModule", { value: true });
var eventSources_1 = __webpack_require__(178);
var eventStore_1 = __webpack_require__(179);
var DateProfileGenerator_1 = __webpack_require__(56);
var event_rendering_1 = __webpack_require__(27);
...
function fetchSource(eventSource, fetchRange, calendar) {
    ...
    sourceDef.fetch({
        ...
        var calError = calendar.opt('eventSourceFailure');
...
function receiveRawEvents(eventStore, eventSource, fetchId, fetchRange, rawEvents, calendar) {
    if (eventSource && // not already removed
        ...
        rawEvents = event_store_1.transformRawEvents(rawEvents, eventSource.eventDataTransform);
        var subset = event_store_1.parseEvents(rawEvents, eventSource.sourceId, calendar);
        if (fetchRange) {
...
var ListEventRenderer = /** @class */ (function (_super) {
    ...
    ListEventRenderer.prototype.fgSegHtml = function (seg) {
        ...
        if (eventDef.isAllDay) {
            ...
            if (seg.isStart) {
                timeHtml = html_1.htmlEscape(this._getTimeText(eventInstance.range.start, seg.end, false // isAllDay
                ));
            }
            else if (seg.isEnd) {
                timeHtml = html_1.htmlEscape(this._getTimeText(seg.start, eventInstance.range.end, false // isAllDay
                ));
            }
...
Object.defineProperty(exports, "__esModule", { value: true });
var FeaturefulElementDragging_1 = __webpack_require__(29);
var ExternalElementDragging_1 = __webpack_require__(151);
var options_1 = __webpack_require__(31);
/*
...
var ExternalDraggable = /** @class */ (function () {
    function ExternalDraggable(el, settings) {
        ...
        this.handlePointerDown = function (ev) {
            var dragging = _this.dragging;
            var _a = _this.settings, minDistance = _a.minDistance, delay = _a.delay;
            ...
            dragging.delay =
                delay != null ?
                    delay :
                    (ev.isTouch ? options_1.globalDefaults.longPressDelay : 0); // TODO: eventually read eventLongPressDelay
        };
        this.handleDragStart = function (ev) {
            if (ev.isTouch &&
...
Object.defineProperty(exports, "__esModule", { value: true });
var ExternalElementDragging_1 = __webpack_require__(151);
var InferredElementDragging_1 = __webpack_require__(193);
/*
...
defaultSeparator) {
    if (defaultSeparator === void 0) { defaultSeparator = options_1.globalDefaults.defaultRangeSeparator; }
    var dateEnv = buildDateEnv(typeof settings === 'object' && settings ? settings : {}); // pass in if non-null object
    var formatter = formatting_1.createFormatter(settings, defaultSeparator);
...
var StandardTheme_1 = __webpack_require__(135);
var JqueryUiTheme_1 = __webpack_require__(136);
var Bootstrap3Theme_1 = __webpack_require__(196);
var Bootstrap4Theme_1 = __webpack_require__(197);
...
*/
var SIMPLE_RECURRING_PROPS = {
    daysOfWeek: null,
    startTime: duration_1.createDuration,
    endTime: duration_1.createDuration
};
recurring_event_1.registerRecurringType({
    parse: function (rawEvent, leftoverProps) {
        if (rawEvent.daysOfWeek ||
            rawEvent.startTime != null ||
            rawEvent.endTime != null) {
            var props = misc_1.refineProps(rawEvent, SIMPLE_RECURRING_PROPS, {}, leftoverProps);
            return {
    ...
    expand: function (typeData, eventDef, framingRange, dateEnv) {
        return expandRanges(typeData.daysOfWeek, typeData.startTime, framingRange, dateEnv);
    }
});
